...
/********* Procedure_blockImpl ************/
 Procedure_blockImpl::Procedure_blockImpl(std::list<Decl_ptr> *p1, std::list<Proc_ptr> *p2, std::list<Stat_ptr> *p3, Return_stat *p4)  {
	m_decl_list = p1;
	m_proc_list = p2;
	m_stat_list = p3;
	m_return_stat = p4;
...
/********* Nested_blockImpl ************/
 Nested_blockImpl::Nested_blockImpl(std::list<Stat_ptr> *p1)  {
	m_stat_list = p1;
	m_attribute.lineno = yylineno;
	m_parent_attribute = NULL;
	std::list<Stat_ptr>::iterator m_stat_list_iter;
